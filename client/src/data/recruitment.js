// ─── Recruitment & Member Onboarding data ─────────────────────────────────────
...
export const STAGE_COLORS = {
  ...
  'Background Check':     { bg: 'bg-amber-100',   text: 'text-amber-700',  dot: 'bg-amber-500'  },
  'Interview':            { bg: 'bg-indigo-100',  text: 'text-indigo-700', dot: 'bg-indigo-500' },
  'Physical / Medical':   { bg: 'bg-pink-100',    text: 'text-pink-700',   dot: 'bg-pink-500'   },
  'Orientation':          { bg: 'bg-purple-100',  text: 'text-purple-700', dot: 'bg-purple-500' },
  'Probationary Member':  { bg: 'bg-green-100',   text: 'text-green-700',  dot: 'bg-green-600'  },
  'Withdrawn':            { bg: 'bg-red-100',     text: 'text-red-700',    dot: 'bg-red-400'    },
  'Declined':             { bg: 'bg-red-100',     text: 'text-red-700',    dot: 'bg-red-400'    },
};
...
export const CHECKLIST_ITEMS = [
  ...
  { id: 'background',     label: 'Background Check Cleared'    },
  { id: 'references',     label: 'References Verified'         },
  { id: 'interview',      label: 'Interview Completed'         },
  { id: 'physical',       label: 'Physical / Medical Cleared'  },
  { id: 'orientation',    label: 'Orientation Completed'       },
  { id: 'gear',           label: 'Gear / ID Issued'            },
  { id: 'scba_fit',       label: 'SCBA Fit Test Completed'     },
  { id: 'member_added',   label: 'Added to Member Roster'      },
];
...
export const initialProspects = [
  {
    ...
    name: 'Kevin Marsh',
    phone: '(555) 301-7741',
    email: 'tbarton@email.com',
    address: '88 Maple Court, Maplewood, OH 44302',
    dob: '1998-04-15',
    source: 'Community Event',
    recruiter: 'Nathan McGee',
    ...
    checklist: {
      application: true, background: false, references: true,
      interview: false, physical: false, orientation: false,
      gear: false, scba_fit: false, member_added: false,
    },
  ...
  },
  {
    ...
    name: 'Tracy Benson',
    phone: '(555) 302-5588',
    email: 'tbenson22@gmail.com',
    address: '14 Birchwood Lane, Maplewood, OH 44302',
    dob: '2001-09-22',
    source: 'Referral — Member',
    recruiter: 'Sandra Kim',
    stage: 'Interview',
    ...
    checklist: {
      application: true, background: true, references: true,
      interview: false, physical: false, orientation: false,
      gear: false, scba_fit: false, member_added: false,
    },
  ...
  },
  {
    ...
    name: 'Carlos Ruiz',
    phone: '(555) 303-9012',
    email: 'cwalsh1995@yahoo.com',
    address: '229 Oak Street, Maplewood, OH 44302',
    dob: '1995-12-03',
    ...
    checklist: {
      application: true, background: true, references: true,
      interview: true, physical: true, orientation: false,
      gear: true, scba_fit: false, member_added: false,
    },
    notes: 'Prior Army combat medic. Has FF I from Texas — checking transferability with OSFM.',
    interviewDate: '2025-12-02',
    physicalDate: '2025-12-15',
    orientationDate: '2026-01-08',
  },
  {
    id: 4,
    name: 'Maria Delgado',
    phone: '(555) 304-2233',
    email: 'dfoley@email.com',
    address: '671 Cedar Ridge Drive, Maplewood, OH 44302',
    dob: '1990-06-17',
    source: 'Ride-Along',
    recruiter: 'Nathan McGee',
    stage: 'Probationary Member',
    ...
    checklist: {
      application: true, background: true, references: true,
      interview: true, physical: true, orientation: true,
      gear: true, scba_fit: true, member_added: true,
    },
    notes: 'Completed probationary period on track. Enrolled in FF I class starting April.',
    interviewDate: '2025-10-10',
    physicalDate: '2025-10-22',
    orientationDate: '2025-11-03',
  },
  {
    id: 5,
    name: 'Sarah Chen',
    phone: '(555) 305-6677',
    email: 'meverett77@gmail.com',
    address: '34 Pinecrest Road, Maplewood, OH 44302',
    dob: '1977-03-29',
    source: 'Referral — Family',
    recruiter: 'Sandra Kim',
    stage: 'Prospect',
    dateAdded: '2026-02-28',
    stageHistory: [
      { stage: 'Prospect', date: '2026-02-28', notes: 'Brother-in-law of Nathan McGee. Expressed interest at February meeting.' },
    ],
    checklist: {
      application: false, background: false, references: false,
      interview: false, physical: false, orientation: false,
      gear: false, scba_fit: false, member_added: false,
    },
  ...
  },
  {
    ...
    name: 'Diane Tolliver',
    phone: '(555) 306-8844',
    email: 'rnguyen_fire@outlook.com',
    address: '102 Elm View Court, Maplewood, OH 44302',
    dob: '2003-08-11',
    source: 'Career Fair / School',
    recruiter: 'Sarah Chen',
    stage: 'Withdrawn',
    ...
    checklist: {
      application: true, background: false, references: false,
      interview: false, physical: false, orientation: false,
      gear: false, scba_fit: false, member_added: false,
    },
