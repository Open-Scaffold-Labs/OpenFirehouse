...
import { Map, Search, Plus, Filter } from 'lucide-react';

// ─── Pre-Plan Setup Wizard ──────────────────────────────────────────────────────────────

export default function PrePlanWizard() {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-black text-gray-900 dark:text-gray-100 tracking-tight">Pre-Plan Setup Wizard</h1>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Step-by-step guided setup for creating new pre-incident plans. Walk through building details, hazards, access points, and tactical considerations.</p>
        </div>
      ...
      <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-700 rounded-2xl shadow-sm p-16 text-center">
        <div className="w-16 h-16 rounded-2xl bg-red-50 dark:bg-red-950/50 flex items-center justify-center mx-auto mb-4">
          <Map size={28} className="text-red-500" />
        </div>
        <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-2">Pre-Plan Setup Wizard</h3>
        <p className="text-sm text-gray-500 dark:text-gray-400 max-w-md mx-auto mb-6">
          Step-by-step guided setup for creating new pre-incident plans. Walk through building details, hazards, access points, and tactical considerations.
        </p>
