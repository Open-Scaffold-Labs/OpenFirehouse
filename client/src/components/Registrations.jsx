  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-black text-gray-900 dark:text-gray-100 tracking-tight">Registrations</h1>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Manage fire safety registrations for properties, systems, and occupancy permits.</p>
        </div>
      ...
      <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-700 rounded-2xl shadow-sm p-16 text-center">
        ...
        <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-2">Registrations</h3>
        <p className="text-sm text-gray-500 dark:text-gray-400 max-w-md mx-auto mb-6">
          Manage fire safety registrations for properties, systems, and occupancy permits.
        </p>
